          ...
          <div className="flex items-center justify-between h-1/2 mb-10">
            <div className="w-1/2">
              <div className='font-semibold my-3'>
                <span className="text-myAccent">|</span> <span>Specialization</span>
              </div>
              ...
              <div className="flex justify-center items-center gap-2">
                <div className=" flex flex-col justify-center ">
                  ...
                  <div>
                    <p>
                      We are committed to delivering the highest level of expertise and
                      knowledge in car detailing, ensuring our clients receive
            ...
            <div className="w-1/2 flex justify-center items-center">
              <Image src='/sec3.jpg' width={600} height={600} className="rounded" />
            </div>
          </div>
          <div className="mt-20">
                ...
                socialMediaData.map((item, index) => {
                  return (
                    <div className="flex items-center" key={index}>
                      <div>
                        <Image src={item.social} width={32} height={32} />
                      </div>
                      <div className="ml-2">
                        <div>
        ...
        <div className="mx-32 h-screen flex flex-col justify-evenly items-start ">
          <div>
            ...
            <div className="text-4xl font-semibold mt-3">
              <p>Experience the ultimate in car
                detailing and <span className='text-myAccent'> diagnosing </span></p>
            </div>
          </div>
          <div className="flex items-center justify-center  w-full">
            <div className="w-1/2">
              <Image src='/service.jpg' width={600} height={700} className="rounded" />
            </div>
            ...
            <div className="w-1/2">
              <div>
                ...
                <div>
                  <p>
                    Our expert team uses the latest techniques and equipment to restore your
                    vehicle’s interior to pristine condition, from leather conditioning to carpet
                    deep cleaning.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div>
                  <p>
                    Our exterior detailing services are tailored to each vehicle, from hand
                    washing to paint protection, ensuring your car looks stunning and
              ...
              <div>
                ...
                <div>
                  <p>
                    Our paint restoration services use the latest technology and techniques to
                    restore your vehicle’s paint to its original beauty and luster.
                  </p>
                </div>
              </div>
              <div>
                ...
                <div>
                  <p>
                    We prioritize customer service, ensuring your experience with us is
      ...
      <div className="h-screen w-full bg-black text-white relative">
        ...
        <div className="mx-32 ">
          ...
          <div className="flex justify-between items-center mb-10 ">
            ...
            <div className='mt-32 mb-6'>
              <Button className="bg-myAccent" variant='ghost'>All Testimonials</Button>
            </div>
          </div>
          <div className="grid grid-cols-2 gap-12 items-center justify-center ">
            <div>
              <div>
                <p className="my-3">“The Maintainer team exceeded my expectations with their attention to
                  detail and exceptional customer service. My car looks brand new, and I
            ...
            <div>
              <div>
                <p className="my-3">“I’ve been to a lot of car detailing services in the past, but Maintainer takes
                  the cake. Their expertise and state-of-the-art equipment make a noticeable
                  difference in the quality of their work.”</p>
              </div>
              <div className='flex justify-between items-center w-fit'>
                <div>
                  <Avatar className="h-12 w-12">
            ...
            <div>
              <div>
                <p className="my-3">“The quality of work Maintainer delivers is unmatched in the region. They go
                  above and beyond to ensure every inch of your car is cleaned and restored to
                  its original beauty.”</p>
              </div>
              <div className='flex justify-between items-center w-fit'>
                <div>
                  <Avatar className="h-12 w-12">
            ...
            <div>
              <div>
                <p className="my-3">“Maintainer is now my go-to car detailing service. Their tailored services and
                  exceptional customer service make them stand out in a sea of competitors.”</p>
              </div>
              <div className='flex justify-between items-center w-fit'>
                <div>
                  <Avatar className="h-12 w-12">
          ...
          <div className=' h-[50vh] flex flex-col items-center justify-evenly'>
            <div>
              ...
              <div className="text-md text-gray-400">
                <p>Book your appointment today and experience the ultimate in car detailing services.</p>
              </div>
              <div>
